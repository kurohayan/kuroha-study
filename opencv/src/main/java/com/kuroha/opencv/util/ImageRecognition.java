...
//        FastFeatureDetector featureDetector = FastFeatureDetector.create(FastFeatureDetector.THRESHOLD);
        //获取模板图的特征点
        ...
        Imgcodecs.imwrite("D:/tmp/photo/4.png",outputImage);
        //获取原图的特征点
...
//            Imgcodecs.imwrite("D:/tmp/photo/原图中的匹配图.jpg", subMat);
...
//            Core.line(originalImage, new Point(pointD), new Point(pointA), new Scalar(0, 255, 0), 4);//左 D->A
            ...
            Imgcodecs.imwrite("D:/tmp/photo/特征点匹配过程.jpg", matchOutput);
            Imgcodecs.imwrite("D:/tmp/photo/模板图在原图中的位置.jpg", originalImage);
        } else {
            System.out.println("模板图不在原图中！");
        }

//        Imgcodecs.imwrite("D:/tmp/photo/模板特征点.jpg", outputImage);
    }
