...
public class HttpClientSender {
    ...
    public static Map<String, Object> request(String method, String url, Object sendData, Map<String, String> headers) throws IOException {
        ...
        String requestPath;
        try {
            requestPath = new java.net.URL(url).getPath();
        }
        ...
        if("POST".equals(method)){
            response = sendPost(httpClient, url, headers, sendData,"application/json");
        }else{
    ...
    public static Map<String, Object> request(String method, String url, Object sendData, Map<String, String> headers,String contentType) throws IOException {
    ...
    private static Map<String, Object> sendPost(CloseableHttpClient httpClient, String url, Map<String, String> headers, Object sendData,String contentType) throws IOException {
